...
import io.kaxis.util.SslContextUtil.Credentials;
...
public class TestCertificatesTools {
	...
	private static final X509KeyManager clientKeyManager;
	private static final X509KeyManager serverKeyManager;
	...
	private static final X509Certificate[] trustedCertificates;
	private static final X509Certificate rootCaCertificate;
	private static final X509Certificate caCertificate;
	private static final X509Certificate caAlternativeCertificate;
	// a certificate without digitalSignature value in keyusage
	private static final X509Certificate nosigningCertificate;
    ...
    assumeTrue(clientExpiredCredentials != null, "client certificate is not expired");
