...
import io.kaxis.exception.StreamOverflowException;
...
public final class Streams {
   ...
   *     has data in it.
   */
  public static void pipeAllLimited(InputStream inStr, long limit, OutputStream outStr)
      throws IOException {
    long total = 0;
    var bs = new byte[BUFFER_SIZE];
    int numRead;
