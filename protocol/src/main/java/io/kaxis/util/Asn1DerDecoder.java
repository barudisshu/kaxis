...
public class Asn1DerDecoder {
	 ...
	 *
	 * @deprecated use {@link JceProvider#EC} instead
	 */
	@Deprecated
	public static final String EC = JceProvider.EC;
	/**
	 * Key algorithm RSA to be used by KeyFactory.
	 *
	 * @deprecated use {@link JceProvider#RSA} instead
	 */
	@Deprecated
	public static final String RSA = JceProvider.RSA;
	/**
	 * Key algorithm DSA to be used by KeyFactory.
	 *
	 * @deprecated use {@link JceProvider#DSA} instead
	 */
	@Deprecated
	 ...
	 *
	 * @deprecated use {@link JceProvider#DH} instead
	 */
	@Deprecated
	 ...
	 * @deprecated use {@link JceProvider#ECv2} instead
	 */
	@Deprecated
	public static final String ECv2 = JceProvider.ECv2;
	/**
	 * Key algorithm ED25519 (RFC 8422).
	 *
	 * @deprecated use {@link JceProvider#ED25519} instead
	 * @since 2.4
	 */
	@Deprecated
	public static final String ED25519 = JceProvider.ED25519;
	/**
	 * Key algorithm Ed25519 v2 (RFC 8410), not to be used by KeyFactory.
	 *
	 * @see #readEdDsaPrivateKeyV2(byte[])
	 *
	 * @deprecated use {@link JceProvider#ED25519v2} instead
	 * @since 3.0
	 */
	@Deprecated
	public static final String ED25519v2 = JceProvider.ED25519v2;
	/**
	 * Key algorithm ED448 (RFC 8422).
	 *
	 * @deprecated use {@link JceProvider#ED448} instead
	 * @since 2.4
	 */
	@Deprecated
	public static final String ED448 = JceProvider.ED448;
	/**
	 * Key algorithm Ed448 v2 (RFC 8410), not to be used by KeyFactory.
	 *
	 * @see #readEdDsaPrivateKeyV2(byte[])
	 *
	 * @deprecated use {@link JceProvider#ED448v2} instead
	 * @since 3.0
	 */
	@Deprecated
	public static final String ED448v2 = JceProvider.ED448v2;
	/**
	 * Key algorithm X25519 (RFC 8422).
	 *
	 * @deprecated use {@link JceProvider#X25519} instead
	 * @since 3.0
	 */
	@Deprecated
	public static final String X25519 = JceProvider.X25519;
	/**
	 * Key algorithm X25519 v2 (RFC 8410), not to be used by KeyFactory.
	 *
	 * @deprecated use {@link JceProvider#X25519v2} instead
	 * @since 3.0
	 */
	@Deprecated
	public static final String X25519v2 = JceProvider.X25519v2;
	/**
	 * Key algorithm X448 (RFC 8422).
	 *
	 * @deprecated use {@link JceProvider#X448} instead
	 * @since 3.0
	 */
	@Deprecated
	public static final String X448 = JceProvider.X448;
	/**
	 * Key algorithm X448 v2 (RFC 8410), not to be used by KeyFactory.
	 *
	 * @deprecated use {@link JceProvider#X448v2} instead
	 * @since 3.0
	 */
	@Deprecated
	public static final String X448v2 = JceProvider.X448v2;
	/**
	 ...
	 * Identifiers</a>).
	 *
	 * @deprecated use {@link JceProvider#OID_X25519} instead
	 * @since 3.0
	 */
	@Deprecated
	public static final String OID_X25519 = JceProvider.OID_X25519;
	/**
	 ...
	 * Identifiers</a>).
	 *
	 * @deprecated use {@link JceProvider#OID_X448} instead
	 * @since 3.0
	 */
	@Deprecated
	public static final String OID_XD448 = JceProvider.OID_X448;
	/**
	 ...
	 * Identifiers</a>).
	 *
	 * @deprecated use {@link JceProvider#OID_ED25519} instead
	 * @since 2.4
	 */
	@Deprecated
	public static final String OID_ED25519 = JceProvider.OID_ED25519;
	/**
	 ...
	 * Identifiers</a>).
	 *
	 * @deprecated use {@link JceProvider#OID_ED448} instead
	 * @since 2.4
	 */
	@Deprecated
	public static final String OID_ED448 = JceProvider.OID_ED448;
	/**
	 * Key algorithm EdDSA (RFC 8422).
	 *
	 * @deprecated use {@link JceProvider#EDDSA} instead
	 * @since 2.4
	 */
	@Deprecated
	public static final String EDDSA = JceProvider.EDDSA;
	/**
	 ...
	 * @return {@link JceProvider#EC}, {@link JceProvider#RSA}, {@link JceProvider#DSA},
	 *         {@link JceProvider#DH}, {@link JceProvider#ED25519},
	 *         {@link JceProvider#ED448}, {@link JceProvider#X25519}, and
	 *         {@link JceProvider#X448} for v1, {@link JceProvider#ECv2},
	 *         {@link JceProvider#ED25519v2}, and {@link JceProvider#ED448v2},
	 *         {@link JceProvider#X25519v2}, and {@link JceProvider#X448v2} for v2,
	...
	private static String getPublicKeyAlgorithm(final byte[] oid, int version) {
		...
		if (Arrays.equals(oid, OID_EC_PUBLIC_KEY)) {
			algorithm = version == 0 ? JceProvider.EC : JceProvider.ECv2;
		} else if (Arrays.equals(oid, OID_RSA_PUBLIC_KEY)) {
			algorithm = version == 0 ? JceProvider.RSA : null;
		} else if (Arrays.equals(oid, OID_DSA_PUBLIC_KEY)) {
			algorithm = version == 0 ? JceProvider.DSA : null;
		} else if (Arrays.equals(oid, OID_DH_PUBLIC_KEY)) {
			algorithm = version == 0 ? JceProvider.DH : null;
		} else if (Arrays.equals(oid, OID_DH_KEY_AGREEMENT)) {
			algorithm = version == 0 ? JceProvider.DH : null;
		} else if (Arrays.equals(oid, OID_ED25519_PUBLIC_KEY)) {
			algorithm = version == 0 ? JceProvider.ED25519 : JceProvider.ED25519v2;
		} else if (Arrays.equals(oid, OID_ED448_PUBLIC_KEY)) {
			algorithm = version == 0 ? JceProvider.ED448 : JceProvider.ED448v2;
		} else if (Arrays.equals(oid, OID_X25519_PUBLIC_KEY)) {
			algorithm = version == 0 ? JceProvider.X25519 : JceProvider.X25519v2;
		} else if (Arrays.equals(oid, OID_X448_PUBLIC_KEY)) {
			algorithm = version == 0 ? JceProvider.X448 : JceProvider.X448v2;
		}
		return algorithm;
	}
	...
	public static boolean isEcBased(String algorithm) {
		if (JceProvider.EC.equalsIgnoreCase(algorithm)) {
			return true;
		} else {
	 ...
	 *         {@link JceProvider#ECv2}, {@link JceProvider#ED25519v2}, and
	 *         {@link JceProvider#ED448v2} for v2, which are not supported by the
	...
	public static Keys readPrivateKey(final byte[] data) throws GeneralSecurityException {
		...
		if (algorithm != null) {
			if (algorithm == JceProvider.ED25519v2 || algorithm == JceProvider.ED448v2) {
				keys = readEdDsaPrivateKeyV2(data);
			} else if (algorithm == JceProvider.ECv2) {
				keys = readEcPrivateKeyV2(data);
			} else if (algorithm == JceProvider.EC) {
		...
		if (readValue.length == 1 && readValue[0] == 0) {
			try {
				...
				if (readValue.length == 1 && readValue[0] == 1) {
					...
					keys = new Keys();
					keys.privateKey = KeyFactory.getInstance(JceProvider.EC).generatePrivate(privateKeySpec);
					// ignore, optional
	...
	public static ECPublicKey readEcPublicKey(DatagramReader reader, ECParameterSpec ecParameterSpec)
		...
		if (compress == EC_PUBLIC_KEY_UNCOMPRESSED && left % 2 == 0) {
			...
			if (left == keySize) {
				...
				return (ECPublicKey) KeyFactory.getInstance(JceProvider.EC).generatePublic(publicKeySpec);
			}
		}
		return null;
	}
	 ...
	 *             in range {@code [1, N-1]}.
	 * @see JceProvider#isEcdsaVulnerable()
	 * @see <a href=
	 ...
	 * @deprecated use
	 *             {@link JceProvider#equalKeyAlgorithmSynonyms(String, String)}
	 *             instead
	 */
	@Deprecated
	public static boolean equalKeyAlgorithmSynonyms(String keyAlgorithm1, String keyAlgorithm2) {
		return JceProvider.equalKeyAlgorithmSynonyms(keyAlgorithm1, keyAlgorithm2);
	}
	...
	public static ECParameterSpec getECParameterSpec(String oid) throws GeneralSecurityException {
		KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance(JceProvider.EC);
	 ...
	 *
	 * Supports {@link JceProvider#ED25519v2} and {@link JceProvider#ED448v2} as well.
	 *
	 * @param algorithm algorithm
	 * @param def default algorithm
	 * @return Either {@link JceProvider#OID_ED25519}, {@link JceProvider#OID_ED448},
	 *         {@link JceProvider#EDDSA}, or the provided default algorithm
	 * @see JceProvider#getEdDsaStandardAlgorithmName(String, String)
	 * @deprecated use
	 *             {@link JceProvider#getEdDsaStandardAlgorithmName(String, String)}
	 *             instead
	 * @since 2.4
	 */
	@Deprecated
	public static String getEdDsaStandardAlgorithmName(String algorithm, String def) {
		return JceProvider.getEdDsaStandardAlgorithmName(algorithm, def);
	}
	...
	public static KeyFactory getKeyFactory(String algorithm) throws NoSuchAlgorithmException {
		String standardAlgorithm = JceProvider.getEdDsaStandardAlgorithmName(algorithm, algorithm);
		...
		public String toString(byte[] oid) {
			...
			for (int index = 1; index < oid.length; ++index) {
				...
				if (bValue < 0) {
					...
					++index;
					if (index == oid.length) {
						throw new IllegalArgumentException("Invalid OID 0x" + Utility.byteArray2Hex(oid));
					}
					value <<= 7;
	...
	private static class StringEntityDefinition extends EntityDefinition {
		...
		private int tag;
		private final int[] expectedTags;
