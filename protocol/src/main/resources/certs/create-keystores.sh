...
remove_interop_keys() {
  echo "remove keys from interoperability-tests"
  DESTINATION_DIR=../../../../../interoperability-tests
...
create_keys() {
   ...
   keytool -genkeypair -alias root -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-root' \
   ...
   keytool -genkeypair -alias ca -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-ca' \
   ...
   keytool -genkeypair -alias caalt -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-ca' \
        -ext BC=1 -validity $VALIDITY -keypass $TRUST_STORE_PWD -keystore $TRUST_STORE -storepass $TRUST_STORE_PWD
   ...
   keytool -genkeypair -alias server -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-server' \
   ...
   keytool -keystore $KEY_STORE -storepass $KEY_STORE_PWD -certreq -alias server | \
      ...
      'san=dns:my.test.server,dns:mahina.kaxis.io,ip:35.185.40.182,dns:localhost,ip:127.0.0.1,ip:::1' \
   ...
   keytool -genkeypair -alias serverrsa -keyalg RSA -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-server-rsa' \
        -validity $VALIDITY -keypass $KEY_STORE_PWD -keystore $KEY_STORE -storepass $KEY_STORE_PWD -storetype $DEFAULT_STORE_TYPE
   keytool -keystore $KEY_STORE -storepass $KEY_STORE_PWD -certreq -alias serverrsa | \
      ...
      -ext 'san=dns:localhost,ip:127.0.0.1,ip:::1,dns:mahina.kaxis.io,ip:35.185.40.182' \
   ...
   keytool -genkeypair -alias ca2 -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-ca2' \
   ...
   keytool -genkeypair -alias serverlarge -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-serverlarge' \
   ...
   keytool -genkeypair -alias carsa -keyalg RSA -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-ca-rsa' \
        -ext BC=0 -validity $VALIDITY -keypass $TRUST_STORE_PWD -keystore $TRUST_STORE -storepass $TRUST_STORE_PWD
   ...
   keytool -genkeypair -alias servercarsa -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-server-ca-rsa' \
        -validity $VALIDITY -keypass $KEY_STORE_PWD -keystore $KEY_STORE -storepass $KEY_STORE_PWD
   ...
   keytool -genkeypair -alias client -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-client' \
        -validity $VALIDITY -keypass $KEY_STORE_PWD -keystore $KEY_STORE -storepass $KEY_STORE_PWD
   ...
   keytool -genkeypair -alias clientexpired -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-client-expired' \
   ...
   keytool -genkeypair -alias clientrsa -keyalg RSA -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-client-rsa' \
        -validity $VALIDITY -keypass $KEY_STORE_PWD -keystore $KEY_STORE -storepass $KEY_STORE_PWD
   ...
   keytool -genkeypair -alias self -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-self' \
   ...
   keytool -genkeypair -alias nosigning -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-nosigning' \
   ...
   keytool -genkeypair -alias clientext -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-clientext' \
        -validity $VALIDITY -keypass $KEY_STORE_PWD -keystore $KEY_STORE -storepass $KEY_STORE_PWD
   ...
   keytool -genkeypair -alias clienteddsa -keyalg Ed25519 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-client-eddsa' \
   ...
   if [ $? -eq 0 ] ; then
      ...
      keytool -genkeypair -alias caeddsa -keyalg Ed25519 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-ca-eddsa' \
      ...
      keytool -genkeypair -alias servereddsa -keyalg Ed25519 -dname 'C=CN,L=Guangzhou,O=Kaxis IoT,OU=Kaxis,CN=cf-server-eddsa' \
           -validity $VALIDITY -keypass $KEY_STORE_PWD -keystore $EDDSA_KEY_STORE -storepass $KEY_STORE_PWD -storetype $DEFAULT_STORE_TYPE
...
copy_pem() {
  echo "copy to interoperability-tests"
  DESTINATION_DIR=../../../../../interoperability-tests
